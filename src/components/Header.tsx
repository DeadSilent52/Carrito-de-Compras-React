import type { CartItem, Shoes } from "../types"


type HeaderProps = {
    cart: CartItem[]
    removeFromCart: (id: Shoes['id']) => void
    decreaseQuantity: (id: Shoes['id']) => void
    increaseQuantity: (id: Shoes['id']) => void
    clearCart: () => void
    isEmpty: boolean
    cartTotal: number
}
                                                ...
                                                <tr key={shoes.id}>
                                                    ...
                                                    <td>
                                                        <button
                                                            ...
                                                            type="button"
                                                            onClick={() => removeFromCart(shoes.id)}
                                                        >
                                                            X
                                                        </button>
                                                    </td>
